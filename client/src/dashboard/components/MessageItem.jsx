  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <div className="flex items-start gap-1 flex-col rounded-[8px] text-wrap max-height-[600px] w-full lg:max-w-[600px] max-w-[400px]">
          <p
      ...
      >
        ...
        <DialogContent className="w-[70%] h-[620px] p-0 shadow-none border-none   rounded-none sm:rounded-none outline-none  max-w-full ">
          ...
          <div className="h-full w-full overflow-hidden flex flex-col">
            ...
            <div className="h-[calc(100%-44px)] w-full  overflow-hidden px-4 flex items-center justify-center">
              <img
